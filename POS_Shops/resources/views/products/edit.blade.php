        ...
        <form method="POST" action="{{ route('products.update', $product) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-text-input id="sku" name="sku" value="{{ old('sku', $product->sku) }}" class="mt-1 block w-full" required />
                ...
                <div>
                    ...
                    <x-text-input id="stock_quantity" name="stock_quantity" type="number" min="0" value="{{ old('stock_quantity', $product->stock_quantity) }}" class="mt-1 block w-full" required />
                    <x-input-error :messages="$errors->get('stock_quantity')" class="mt-2" />
                </div>

                <div>
                    <x-input-label for="price" value="Selling Price ($)" />
                    <x-text-input id="price" name="price" type="number" step="0.01" min="0" value="{{ old('price', $product->price) }}" class="mt-1 block w-full" required />
                    <x-input-error :messages="$errors->get('price')" class="mt-2" />
                </div>

                <div>
                    <x-input-label for="cost" value="Cost Price ($)" />
                    <x-text-input id="cost" name="cost" type="number" step="0.01" min="0" value="{{ old('cost', $product->cost) }}" class="mt-1 block w-full" />
