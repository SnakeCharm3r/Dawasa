...
class CurrentSupplierKycSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::transaction(function () use ($reviewer): void {
            $currentCodes = collect(self::SUPPLIERS)->pluck('code');

            // Preserve historical procurement links while removing old suppliers
            // from normal supplier queries and sourcing selectors.
            Supplier::query()->whereNotIn('code', $currentCodes)->delete();
